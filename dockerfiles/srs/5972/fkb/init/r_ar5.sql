...
); SELECT ADDGEOMETRYCOLUMN('', 'app_arealressursflate','app_område_value','25832','GEOMETRY', 2); SELECT ADDGEOMETRYCOLUMN('', 'app_arealressursflate','app_posisjon_value','25832','GEOMETRY', 2); CREATE TABLE app_arealressursgrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_arealressursgrense','app_grense_value','25832','GEOMETRY', 2); CREATE TABLE app_arealressursgrensefiktiv (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_arealressursgrensefiktiv','app_grense_value','25832','GEOMETRY', 2); CREATE TABLE app_kantutsnitt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_grense_attr_nilreason text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_kantutsnitt','app_grense_value','25832','GEOMETRY', 2)
