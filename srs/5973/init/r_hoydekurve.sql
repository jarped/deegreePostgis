...
); SELECT ADDGEOMETRYCOLUMN('', 'app_bruddlinje','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_dtmpunkt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_dtmpunkt','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_forsenkningskurve (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_forsenkningskurve','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_forsenkningspunkt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_forsenkningspunkt','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_fyllingkant (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_fyllingkant','app_grense_value','5973','GEOMETRY', 3); CREATE TABLE app_hjelpekurve (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_hjelpekurve','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_høydekurve (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_høydekurve','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_skjæringkant (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_skjæringkant','app_grense_value','5973','GEOMETRY', 3); CREATE TABLE app_terrenglinje (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_terrenglinje','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_terrenglinjebygg (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_terrenglinjebygg','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_terrenglinjeveg (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_terrenglinjeveg','app_senterlinje_value','5973','GEOMETRY', 3); CREATE TABLE app_terrengpunkt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_terrengpunkt','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_toppunkt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_toppunkt','app_posisjon_value','5973','GEOMETRY', 3)
