...
); SELECT ADDGEOMETRYCOLUMN('', 'app_andretiltak','app_område_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_andretiltak','app_senterlinje_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_andretiltak','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_kantutsnitt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_kantutsnitt','app_grense_value','5973','GEOMETRY', 3); CREATE TABLE app_pblsøknad (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_pblsøknad','app_område_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_pblsøknad','app_senterlinje_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_pblsøknad','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_pblsøknadgrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_pblsøknadgrense','app_grense_value','5973','GEOMETRY', 3); CREATE TABLE app_pbltiltak (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_pbltiltak','app_område_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_pbltiltak','app_senterlinje_value','5973','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_pbltiltak','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_tiltakgrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_tiltakgrense','app_grense_value','5973','GEOMETRY', 3)
