...
CREATE TABLE app_el_belysningspunkt (
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_el_belysningspunkt','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_el_belysningspunkt_app_fellesføring (
    id serial PRIMARY KEY,
    parentfk text NOT NULL REFERENCES app_el_belysningspunkt ON DELETE CASCADE,
    num integer not null,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_el_flymarkør','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_el_nettstasjon (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_el_nettstasjon','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_el_vindturbin (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_el_vindturbin','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_kanal (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_kanal','app_beliggenhet_value','5973','GEOMETRY', 3); CREATE TABLE app_lednkum (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_lednkum','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_lednkum_app_fellesføring (
    id serial PRIMARY KEY,
    parentfk text NOT NULL REFERENCES app_lednkum ON DELETE CASCADE,
    num integer not null,
    app_fellesføring_app_fellesføringtype text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_mast','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_mast_app_fellesføring (
    id serial PRIMARY KEY,
    parentfk text NOT NULL REFERENCES app_mast ON DELETE CASCADE,
    num integer not null,
    app_fellesføring_app_fellesføringtype text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_masteomriss','app_omriss_value','5973','GEOMETRY', 3); CREATE TABLE app_masteomriss_app_eier (
    id serial PRIMARY KEY,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_nettstasjonadkomst','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_nettstasjonadkomst_app_eier (
    id serial PRIMARY KEY,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_nettverkstasjonomriss','app_omriss_value','5973','GEOMETRY', 3); CREATE TABLE app_nettverkstasjonomriss_app_eier (
    id serial PRIMARY KEY,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_skap','app_posisjon_value','5973','GEOMETRY', 3); CREATE TABLE app_trase (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_trase','app_beliggenhet_value','5973','GEOMETRY', 3); CREATE TABLE app_åk (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_medium text,
    ...
    app_eier_app_eier text,
    app_eier_app_eier_andel numeric
); SELECT ADDGEOMETRYCOLUMN('', 'app_åk','app_geometri_value','5973','GEOMETRY', 3)
