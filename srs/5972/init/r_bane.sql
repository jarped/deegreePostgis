...
); SELECT ADDGEOMETRYCOLUMN('', 'app_jernbaneplattformkant','app_grense_value','5972','GEOMETRY', 3); CREATE TABLE app_spormidt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_spormidt','app_senterlinje_value','5972','GEOMETRY', 3)
