...
); SELECT ADDGEOMETRYCOLUMN('', 'app_lufthavnlys','app_posisjon_value','5972','GEOMETRY', 3); CREATE TABLE app_plattformgrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_plattformgrense','app_grense_value','5972','GEOMETRY', 3); CREATE TABLE app_rullebanegrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_rullebanegrense','app_grense_value','5972','GEOMETRY', 3); CREATE TABLE app_taksebanegrense (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_taksebanegrense','app_grense_value','5972','GEOMETRY', 3)
