...
); SELECT ADDGEOMETRYCOLUMN('', 'app_kumlokk','app_senterlokk_value','5972','GEOMETRY', 3); CREATE TABLE app_va_hydrant (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_datafangstdato date,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_va_hydrant','app_posisjon_value','5972','GEOMETRY', 3); CREATE TABLE app_va_sluk (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_datafangstdato date,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_va_sluk','app_posisjon_value','5972','GEOMETRY', 3)
