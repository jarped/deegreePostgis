...
); SELECT ADDGEOMETRYCOLUMN('', 'app_allé','app_senterlinje_value','5972','GEOMETRY', 3); CREATE TABLE app_hekk (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_hekk','app_senterlinje_value','5972','GEOMETRY', 3); CREATE TABLE app_innmålttre (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_innmålttre','app_posisjon_value','5972','GEOMETRY', 3); CREATE TABLE app_kantutsnitt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_kantutsnitt','app_grense_value','5972','GEOMETRY', 3); CREATE TABLE app_stein (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_stein','app_område_value','5972','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_stein','app_posisjon_value','5972','GEOMETRY', 3); CREATE TABLE app_steinomriss (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_steinomriss','app_grense_value','5972','GEOMETRY', 3)
