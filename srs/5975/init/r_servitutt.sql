...
); SELECT ADDGEOMETRYCOLUMN('', 'app_kantutsnitt','app_grense_value','5975','GEOMETRY', 3); CREATE TABLE app_servitutt (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_servitutt','app_område_value','5975','GEOMETRY', 3); SELECT ADDGEOMETRYCOLUMN('', 'app_servitutt','app_posisjon_value','5975','GEOMETRY', 3); CREATE TABLE app_servitutt_app_servituttgruppe (
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_servituttgrense','app_grense_value','5975','GEOMETRY', 3); CREATE TABLE app_servituttgrensefiktiv (
    attr_gml_id text,
    gml_identifier text,
    gml_identifier_attr_codespace text,
    app_identifikasjon_app_identifikasjon_app_lokalid text,
...
); SELECT ADDGEOMETRYCOLUMN('', 'app_servituttgrensefiktiv','app_grense_value','5975','GEOMETRY', 3)
